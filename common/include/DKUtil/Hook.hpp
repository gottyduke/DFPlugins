...
namespace DKUtil::Alias
{
	...
	using Module = DKUtil::Hook::Module;
	using Trampoline = DKUtil::Hook::Trampoline;

	template <class... Rules>
	using PatternMatcher = DKUtil::Hook::detail::PatternMatcher<Rules...>;
}  // namespace DKUtil::Alias
...
#undef DKU_H_VERSION_MAJOR
#undef DKU_H_VERSION_MINOR
#undef DKU_H_VERSION_REVISION
